...
#define API_KEY "AIzaSyB7DO1fTjiCgswbrXvBqkZQgwkAA5fMkbE" //Your Youtube API-Key 
#define CHANNEL_ID "UCB_FkJlhZDNjvNCBBwukoXQ" // Your youtube channel ID. 
...
const char* ssid     = "Supriya";      // SSID of local network
const char* password = "v8971715218";                // Password on network
